...
def generate_launch_description():
    ...
    default_world = PathJoinSubstitution(
        [FindPackageShare("trashbot_description"), "worlds", "mari_park_test.world"]
    )
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="Gazebo world file. Defaults to the Mari park RTAB-Map test world.",
            ),
            DeclareLaunchArgument(
                "gui",
                default_value="true",
            ...
            DeclareLaunchArgument(
                "use_mesh_visual",
                default_value="false",
                description="Use Mari STL visual. false matches the low-load mapping profile.",
            ),
            DeclareLaunchArgument(
