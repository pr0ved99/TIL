...
- `docs/progress/2026-08-27_progress.md`: current continuation state; partial parts arrival, P-02B~P-02C-2 and P-03A/P-03B source/static/full-build completion, canonical `26/26` and immediate incoming-inspection boundary
