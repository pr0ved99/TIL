...
- `docs/progress/2026-08-27_progress.md`: current continuation state; partial parts arrival, P-02B/P-02C-1/P-02C-2 completion, canonical `25/25`, full-build/link evidence and immediate incoming-inspection boundary
...
4. Preserve the all-hooks-`0U` current source, TIM4 period `4420`, current host/static `25/25` and final 5 s D0~D3 all-LOW capture. Earlier UART-safe artifact hashes and `15/15`, `20/20`, `23/23`, `24/24` checkpoints remain historical; host/static PASS does not replace board or electrical evidence.
...
9. `P-01` is complete through Accepted ADR-015. `P-02A/P-02B` mapper and `P-02C-1` signed adapter checkpoints are complete. `P-02C-2` production caller/static/full-build and nonzero linkage are also complete; the immediate software task is `P-03` timeout-to-`DISARMED` recovery. Plate identification/dry fit remains a separate home `H-01` checkpoint.
