# STM32 Practice Log Index

## Policy

실습 파일은 번호를 붙여 시간 순서와 의존성을 유지한다.
...
| 002 | TIM encoder mode bring-up | NUCLEO-F446RE | Partial | PB4/PB5 TIM3와 PA0/PA1 TIM5 dual motor-power-off PASS; speed와 powered-noise pending |
...
| 006 | ADC battery divider dry-run | NUCLEO-F446RE | Planned | PA4, safe divided voltage only |
