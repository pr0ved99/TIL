...
## Physical E-stop Procurement Snapshot — 2026-08-28
...
| Crimp tool | `VH-30J` interchangeable-die set, including `WX-03B` | 1 set | First-article 18 AWG connector crimp and candidate AWG 12 terminal tooling | ORDERED / NOT RECEIVED / DIE GEOMETRY AND CRIMP QUALITY NOT VALIDATED |
