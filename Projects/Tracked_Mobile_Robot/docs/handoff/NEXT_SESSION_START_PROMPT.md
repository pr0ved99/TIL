...
9/19 종료 지점: UART/CTRL/ENC/IMU 배선과 안내한 무전원 검사·마감은 완료다.
다음은 T004 BUILD-01이며 STM32/ESP32 빌드와 플래시는 내가 직접 한다.
T004 hook=1U 이미지는 READY 뒤 자동 ARM/CMD를 보내므로 USB 연결 전 PRE-01/DEV-01을 따른다.
완료한 배선 검사나 코드 입력을 반복하지 마라.
