...
> 2026-09-22 업데이트: [report 26](26_T_ESTOP_004_Conditioned_PWM_Latch_Reset_and_Safe_Restore_Test_Report_2026-09-22_ko.md)에서 T-ESTOP-004 conditioned firmware/PWM, same-run
> reset/no-replay, wire-open과 hook0 safe restore를 PASS했다. Static 30/30. 이는 전체
> Physical E-stop 또는 실제 motor 검증 완료를 뜻하지 않는다. 아래 과거 날짜의 29/29와
> 미실행 설명은 역사 checkpoint이며 현재 T004 결과는 report 26을 따른다.
