...
| Physical E-stop | MVP: `VBAT_PROTECTED -> K1 -> MOTOR_VBAT_SAFE -> MDD10A`; `F2 -> S0-A NC -> [S2 NO OR K2-HOLD-NO] -> K2`, K2 second pole -> K1 coil; 5 V S0-B/opto PC7 sense; post-MVP: PA4/PB0 rail sense | Functional schematic/ERC complete; visual layout accepted as WIP; actual parts, K1/F1/main rating and motor-disconnected bench remain open |
| MDD10A logic | `PC8/DIR1`, `PB6/TIM4_CH1/PWM1`, `PC9/DIR2`, `PB7/TIM4_CH2/PWM2`, 각 signal-to-GND `10 kΩ`, common GND | Breadboard reset FAIL -> pull-down 적용 5 s/20 M samples all-LOW PASS; RevB-WIP schematic/ERC/PDF PASS; permanent wiring continuity pending |
...
- MDD10A DIR1/PWM1/DIR2/PWM2 외부 `10 kΩ` pull-down의 permanent assembly와 continuity 확인
